    ...
    let frameworkSection = (
      <div className="project-section framework-section">
        ...
        <ProjectLinks
          ...
          github={"https://github.com/mimcmahon20/Jammming-Spotify-Playlists"}
          live={
            "https://64b6e8a50d37e00008c83a2d--zippy-churros-8887e2.netlify.app/"
          }
        />
      </div>
    );
        ...
        <div className="center-carousel">
          <div className="carousel-container">
            <div className="media-carousel" ref={(el) => (carousel = el)}>
              <ProjectMedia url={"/Videos/jammmingvideo.mp4"} type={"video"} thumbnail={jammmingscreenshot} />
